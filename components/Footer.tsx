...
export default function Footer() {
  return (
    <div className="h-[40rem] pt-20 w-full rounded-md bg-slate-950 relative flex flex-col items-center justify-center antialiased px-6 sm:px-8 lg:px-12">
      <footer className="w-full">
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="lg:flex lg:items-start lg:gap-8">
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16 pl-4 sm:pl-6 lg:pl-8">
