...
//   return (
//     <div className="h-[40rem] mt-36 w-full rounded-md bg-slate-950 relative flex flex-col items-center justify-center antialiased px-8 sm:px-12 lg:px-16">
//       <footer className="w-full">
//         <div className="mx-auto max-w-screen-xl px-8 py-8 sm:px-12 lg:px-16">
//           <div className="lg:flex lg:items-start lg:gap-8">
//             <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16 pl-8 md:pl-12 lg:pl-16">
...
//       {/* SVG Background */}
//       <div className="h-full w-full inset-0 [mask-size:40px] [mask-repeat:no-repeat] flex items-center justify-center relative -z-1">
//         <svg
...
export default function Footer() {
  return (
    <div className="w-full flex justify-center items-center bg-slate-950 mt-36 py-20">
        ...
        <footer className="w-full">
          ...
          <div className="w-full">
            <div className="lg:flex lg:items-start lg:gap-8">
              <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                ...
                <div className="col-span-2">
                  ...
                  <p className="mt-4 text-gray-400">
                    "Confused about what parts to buy? Don’t worry! Visit our
                    forum and ask the community."
                  </p>
                </div>

                {/* Logo */}
                <div className="col-span-2 lg:col-span-3 flex justify-end items-end">
                  <Image
                    alt="custom-computers"
                    width={230}
                    height={230}
                ...
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <ul className="mt-6 space-y-4 text-sm">
                    <li>
                      <Link className="text-gray-300 hover:opacity-75" href="/">
                        Home
                      </Link>
                    </li>
                    <li>
                      <Link
                        className="text-gray-300 hover:opacity-75"
                        href="/browse"
                      >
                        browse
                      </Link>
            ...
            <div className="mt-8 border-t border-gray-800 pt-8">
              <div className="sm:flex sm:justify-between text-gray-400 text-xs">
                <p>© 2024. custom PC builder. All rights reserved.</p>
